...
public class WinLossRate extends ApplicationFrame {
    ...
    private DefaultCategoryDataset createDataset() {
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            @Override
            public void run() {
                dataset.setValue(GameStateFactory.getAnalyticsRepository().winCount(), "Won", "Amount");
                dataset.setValue(GameStateFactory.getAnalyticsRepository().lossCount(), "Loss", "Amount");
                dataset.setValue(GameStateFactory.getAnalyticsRepository().winLossRatio(), "Win / Loss Ratio", "Ratio");
