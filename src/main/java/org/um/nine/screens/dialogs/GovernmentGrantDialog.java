...
public class GovernmentGrantDialog extends BaseAppState {
    ...
    protected void initialize(Application application) {
        ...
        Label title = window.addChild(new Label("Build a research station in:"));
    ...
    private void renderInfo() {
        ...
        cities.addClickCommands(listCommand -> {
            setEnabled(false);
            try {
                cityRepository.addResearchStation(cities.getSelectedItem(),null);
